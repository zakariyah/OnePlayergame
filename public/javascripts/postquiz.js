function postQuizQuestions(hiitNumber)
{
var postQuizHtmlQuiz = "<form name='postquizsurvey' method='post' action='./postquizsurvey' class='form-horizontal' role='form'><div class='form-group'>";
    postQuizHtmlQuiz += "<input name='hiitNumber' value='" + hiitNumber +"' style='display:none'>";  
...
postQuizHtmlQuiz += "<input name='proceed' type='submit' class='btn btn-primary' value='Submit'/></div></div>";
